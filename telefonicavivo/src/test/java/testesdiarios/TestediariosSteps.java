...
//    	driver.findElement(By.xpath("html/body/div/ui-view/ui-view/section/div/div/div/article[3]/div[1]/div[4]/div[2]/atom-button/button")).click();
    	...
    	act.moveToElement(driver.findElement(By.xpath("html/body/div/ui-view/ui-view/section/div/div/div/article[3]/div[1]/div[4]/div[2]/atom-button/button"))).click().build().perform();
...
//==> Acessa Página Vivo TV
    ...
    public void acessapagvivoTV()  throws InterruptedException {
    	driver.navigate().to("https://assine.vivo.com.br/porto-alegre_RS");
    	Thread.sleep(3000);
    ...
    public void cliquemodalvivoTV() throws InterruptedException {
    	...
    	driver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
        Thread.sleep(3000);
    	driver.findElement(By.xpath("//*[@id=\"mainView\"]/ui-view/div/div[2]/section/form/div/div/button[1]")).click();
    	driver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
    	Thread.sleep(3000);
    }
